...
TEST_F(BugVerificationTest, Bug2_Clone_Independence) {
    ...
    for (float v : orig_cpu) std::cout << v << " ";
    std::cout << std::endl;
    ...
    for (float v : clone_cpu) std::cout << v << " ";
    std::cout << std::endl;
...
TEST_F(BugVerificationTest, Bug_Impact_KMeans_CentroidUpdate) {
    ...
    std::cout << "Labels: [";
    for (int l : labels_data) std::cout << l << " ";
    std::cout << "]" << std::endl;
    ...
    try {
        ...
        for (float v : selected_cpu) std::cout << v << " ";
        std::cout << std::endl;
...
TEST_F(BugVerificationTest, Bug_Impact_KMeans_ConvergenceCheck) {
    ...
    for (float v : old_cpu) std::cout << v << " ";
    std::cout << std::endl;
