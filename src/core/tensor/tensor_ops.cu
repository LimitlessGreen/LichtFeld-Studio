...
namespace gs::tensor_ops {
    ...
    struct ClampScalarFunctor {
        ...
        ClampScalarFunctor(float min, float max) : min_val(min),
                                                   max_val(max) {}
    ...
    struct ClampScalarIntFunctor {
        ...
        ClampScalarIntFunctor(int min, int max) : min_val(min),
                                                  max_val(max) {}
    ...
    struct BinaryScalarOpFunctor {
        ...
        BinaryScalarOpFunctor(T scalar_, BinaryOp op_) : scalar(scalar_),
                                                         op(op_) {}
    ...
    struct ComparisonScalarOpFunctor {
        ...
        ComparisonScalarOpFunctor(T scalar_, BinaryOp op_) : scalar(scalar_),
                                                             op(op_) {}
    ...
    __global__ void cumsum_layer_kernel(T* data, size_t total, size_t dim_stride,
        ...
        if (coord_along_dim != current_layer)
            return;
