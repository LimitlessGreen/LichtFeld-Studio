...
namespace gs {
    ...
    CameraRef::CameraRef(const CameraRef& other, const torch::Tensor& transform)
        : _uid(other._uid),
    ...
    torch::Tensor CameraRef::K() const {
    ...
    std::tuple<float, float, float, float> CameraRef::get_intrinsics() const {
    ...
    torch::Tensor CameraRef::load_and_get_image(int resize_factor, int max_width) {
    ...
    void CameraRef::load_image_size(int resize_factor, int max_width) {
    ...
    size_t CameraRef::get_num_bytes_from_file(int resize_factor, int max_width) const {
        auto result = get_image_info(_image_path);
    ...
    size_t CameraRef::get_num_bytes_from_file() const {
